# Generated by Django 2.1.5 on 2019-01-27 06:45
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('stock_caja', models.IntegerField(blank=True, null=True)),
                ('stock', models.IntegerField(blank=True, null=True)),
                ('precio_unidad', models.DecimalField(decimal_places=2, max_digits=5)),
                ('precio_caja', models.DecimalField(blank=True, decimal_places=2, max_digits=5, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nombre_presentacion', models.CharField(max_length=45)),
            ],
        ),
        migrations.AddField(
            model_name='articulo',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='articulos.Presentacion'),
        ),
    ]
