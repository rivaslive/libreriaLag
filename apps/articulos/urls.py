...
from apps.articulos.views import articulo, habilitarArticulo, LineChartJSONView,mostrarDeshabilitados ,inventario, CrearArticulo, ArticuloListClass, articuloListJSON,articuloDetalle, buscar, inicio, generador, articulo_edi, actualizarEstado
...
urlpatterns = [
    ...
    path('LineChartJSONView/', LineChartJSONView.as_view(), name="LineChartJSONView"),
]
